...
public class SystemAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public void populateTree(){
        ...
        for(int i=0;i<networkList.size();i++){
            ...
            enterpriseList=network.getEnterpriseDirectory().getEnterpriseLst();
            for(int j=0; j<enterpriseList.size();j++){
                enterprise=enterpriseList.get(j);
                enterpriseNode=new DefaultMutableTreeNode(enterprise.getOrgName());
                networkNode.insert(enterpriseNode, j);
                
                organizationList=enterprise.getOrganizationDirectory().getOrganizationLst();
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(230, 224, 224));
        ...
        jPanel2.setBackground(new java.awt.Color(230, 224, 224));
        ...
        lblSelectedNode.setFont(new java.awt.Font("Nirmala UI", 1, 24)); // NOI18N
        ...
        btnManageNetwork.setFont(new java.awt.Font("Nirmala UI", 1, 24)); // NOI18N
        ...
        btnManageEnterprise.setFont(new java.awt.Font("Nirmala UI", 1, 24)); // NOI18N
        ...
        btnManageAdmin.setFont(new java.awt.Font("Nirmala UI", 1, 24)); // NOI18N
    ...
    private void btnManageNetworkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageNetworkActionPerformed
        ...
        log.debug("network created" +CLASS_NAME);
    ...
    private void btnManageEnterpriseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageEnterpriseActionPerformed
      if(ecosystem.getNetworkLst().size()<=0)
      {
          JOptionPane.showMessageDialog(null,"Network unavailable");
          return;
                  }
      else
      {
        ManageEnterpriseJPanel manageEnterpriseJPanel=new ManageEnterpriseJPanel(userProcessContainer, ecosystem);
        log.debug("enterpirse created by user" +CLASS_NAME);
    ...
    private void btnManageAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageAdminActionPerformed
        int i =0;
        for(Network n:ecosystem.getNetworkLst() )
        {
            for(Enterprise e :n.getEnterpriseDirectory().getEnterpriseLst())
            {
                i++;
        ...
        if(i<=0)
        {
            JOptionPane.showMessageDialog(null,"Enterprise unavailable, cannot create admin");
            return;
        }
        ManageEnterpriseAdminJPanel manageEnterpriseAdminJPanel=new ManageEnterpriseAdminJPanel(userProcessContainer, ecosystem);
        log.debug("enterprise admin added" +CLASS_NAME);
