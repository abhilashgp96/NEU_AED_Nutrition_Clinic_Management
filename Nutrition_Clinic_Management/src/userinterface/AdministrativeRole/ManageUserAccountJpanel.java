...
public class ManageUserAccountJpanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 120, -1, 264));

        manageuserLbl.setFont(new java.awt.Font("Nirmala UI", 1, 48)); // NOI18N
        manageuserLbl.setText("Manage User Account");
        add(manageuserLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 40, -1, -1));

        jLabel5.setFont(new java.awt.Font("Nirmala UI", 1, 24)); // NOI18N
        jLabel5.setText("Organization:");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 410, -1, -1));
        ...
        add(organizationComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 410, 210, -1));

        jLabel3.setFont(new java.awt.Font("Nirmala UI", 1, 24)); // NOI18N
        jLabel3.setText("Employee:");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 460, 162, -1));
        ...
        add(employeeComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 460, 210, -1));

        jLabel4.setFont(new java.awt.Font("Nirmala UI", 1, 24)); // NOI18N
        jLabel4.setText("Role:");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 510, 72, -1));
        ...
        add(roleComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 510, 210, -1));

        jLabel1.setFont(new java.awt.Font("Nirmala UI", 1, 24)); // NOI18N
        jLabel1.setText("User Name:");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 560, -1, -1));
        ...
        add(nametxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 560, 210, -1));
        ...
        add(passwordTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 610, 210, -1));

        jLabel2.setFont(new java.awt.Font("Nirmala UI", 1, 24)); // NOI18N
        jLabel2.setText("Password:");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 610, 130, -1));
        ...
        add(backBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 670, 112, 30));

        createUserbtn.setBackground(new java.awt.Color(0, 0, 0));
        createUserbtn.setFont(new java.awt.Font("Nirmala UI", 1, 18)); // NOI18N
    ...
    private void createUserbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserbtnActionPerformed
        ...
        for(UserAccount e: organization.getUserAccountDirectory().getUserAccLst())
        {
...
private void populateRoleComboBox(Organization organization){
 ...
 public void populateData() {
        ...
        for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationLst()) {
            for (UserAccount ua : organization.getUserAccountDirectory().getUserAccLst()) {
