 ...
 * @author abhilashgp
 */
public class ProcessDishFoodWorkRequest extends javax.swing.JPanel {

    /**
     * Creates new form ProcessDishFoodWorkRequest
     */
    
    JPanel userProcessContainer;
    DishWorkRequest request;
    private static Logger log = Logger.getLogger(ProcessDishFoodWorkRequest.class);
    private static final String CLASS_NAME = ProcessDishFoodWorkRequest.class.getName();
    public ProcessDishFoodWorkRequest(JPanel userprocessContainer,DishWorkRequest request) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PROCESSING DISHFOOD SUPPLIER REQUEST ");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 70, -1, 53));
       ...
       try{ 
        ...
        int day=dateFld.getCalendar().get(Calendar.DAY_OF_MONTH);
         String result=year+"-"+month+"-"+day;
           ((DishWorkRequest) request).setDeliveryTime(result);
